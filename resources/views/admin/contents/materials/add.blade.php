        ...
        <h3>MATERIALS</h3>
           ...
           <!--    <div class="title_right">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea name="material_source" style="border-color: #aaa!important;" id="material_source" required="required" class="form-control col-md-7 col-xs-12" rows='3'></textarea>
              </div>
