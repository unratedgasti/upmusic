...
<div class="right_col" role="main">
  <div class="">
      ...
      <div class="title_left">
        ...
        <div class="btn-group" style="padding-bottom:10px;">
          ...
          <ul role="menu" class="dropdown-menu">
            <li><a href="{{URL::to('/admin/subjects/view?list=all')}}">All</a>
            </li>
            <li><a href="{{URL::to('/admin/subjects/view?list=active')}}">Active</a>
            </li>
            <li><a href="{{URL::to('/admin/subjects/view?list=inactive')}}">Inactive</a>
            </li>            
          </ul>
        </div>
      </div>
        ...
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button class="btn btn-default" id="search_btn_subjects" type="button">Go!</button>
    ...
    <div class="alert alert-success alert-dismissible " role="alert">
     <strong>Subject Successfully Updated!</strong>
      ...
      <div class="x_panel">
        <div class="x_title">
          <h2>List - {{ucfirst($_GET['list'])}}</h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive"  style="overflow-x: auto; width:100%;padding-bottom:20px" >
                      ...
                      <!--     <tr class="headings">
                            ...
                            <th class="column-title" style="text-align: center!important;">Subject Description</th>          
                        ...
                        <tbody>
                          ...
                          <tr class="even pointer">
                           <td class="" align="center" style="vertical-align:middle;">
                            <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                             <li><a href="{{URL::to('/admin/subjects/edit?id='.$subject->subject_id)}}">Edit</a>
                                </li>
                              </li>
                              <li><a href="{{URL::to('/admin/subjects/changestatus?list=active&id='.$subject->subject_id.'&status=1')}}">Deactivate</a>
                              </li>
                          ...
                          <td class=" " style="white-space: nowrap; text-align: center!important;">{{$subject->subject_desc}}</td>                                                   
                        </tr>
                        @else
                          ...
                          <td class="" align="center" style="vertical-align:middle;">
                            <div class="btn-group">
                              ...
                              <ul role="menu" class="dropdown-menu">
                                ...
                                <li><a href="{{URL::to('/admin/subjects/changestatus?list=active&id='.$subject->subject_id.'&status=0')}}">Activate</a>
                                </li>
                          <!--     <li class="divider"></li>
                              <li><a href="#">Separated link</a>
                              </li> -->
                ...
                {!! $subjects->appends(['list' => $_GET['list']])->render() !!} 
              </div>
            </div>
          </div>
        </div>
